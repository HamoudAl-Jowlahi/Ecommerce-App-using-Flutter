              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    BuildTextField(
                      controller: cont.read<AuthCubit>().emailController,
                    ...
                    BuildTextField(
                      controller: cont.read<AuthCubit>().passwordController,
                    ...
                    Center(
                      child: SizedBox(
                        ...
                        child: CustomElevatedButton(
                          ...
                          onTap: () {
                            cont.read<AuthCubit>().signIn().then(
                                  (value) {
                                    if (value) {
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () =>
                              Navigator.pushNamed(context, Routes.signUpRoute,arguments: cont),
                          child: Text(
                            'Create Account',
                            style: getSemiBoldStyle(color: ColorManager.white)
                                .copyWith(fontSize: FontSize.s16.sp),
